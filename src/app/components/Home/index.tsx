...
export default function HomePage() {
    const [text, setText] = useState('ahmad-husirami.vercel.app')
    ...
    const onChangeText = (e: React.ChangeEvent<HTMLInputElement | HTMLTextAreaElement>) => {
        setText(e.target.value || 'https://ahmad-husirami.vercel.app/')
                        ...
                        <div className="flex flex-col gap-6 text-sm text-slate-500 max-lg:w-full  max-lg:gap-3">
                            ...
                            <div className="flex flex-col gap-2">
                                ...
                                <TextArea
                                    ...
                                    placeholder="https://ahmad-husirami.vercel.app/"
                                    style={{resize: 'none' }}
                            ...
                            <span className="flex flex-col gap-2">
                                ...
                                <Upload
                                    ...
                                    action="https://run.mocky.io/v3/4ed87de3-ffdd-4f47-b4cb-3ca46ecb9afd"
                                >
                                    <Button
